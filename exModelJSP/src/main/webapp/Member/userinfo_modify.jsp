...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="./img/title1.gif" ><br>    
	<form name="member" method="post" action="userinfo_modify_pro.jsp">
					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=name size=16 maxlength=20 value="<%= dto.getName() %>" readonly> 변경할 수 없습니다.
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor=WHITE valign=middle> 
									...
									<br><input type="checkbox" name="fa" value="여행레져" <% if(dto.getFavorite()!=null&&dto.getFavorite().contains("여행레져")) {%> checked <% } %>>여행레져 &nbsp;&nbsp;
