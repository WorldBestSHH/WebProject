...
<script>
	function board_delete() {
		...
		url = "/BoardEditor/board_delete.do?idx=${dto.idx}&page=${page}";
			...
			<td width="80%" valign="top">&nbsp;<br>
						...
						<td class="content">
							<p align="right">
								<font size="2" face="돋움"> <a class="list"
									...
									<p>${dto.contents} <!-- 썸머노트 사용하면 replace 안해도 됨 -->
									<p>
						</td>
					</tr>
				...
				<p align="center">
					<font size="2"> 
						...
						<!-- 수정하기 -->
						<a href="/BoardEditor/board_modify.do?idx=${dto.idx}&page=${page}">
							<img src="./img/edit.gif" border="0"></a>&nbsp;&nbsp; 
						<!-- 삭제하기 --> 
						<a href="javascript:board_delete()">
							<img src="./img/del.gif" border="0"></a>&nbsp;&nbsp; 
						<!-- 목록보기 --> 
						<a href="/BoardEditor/board_list.do?page=${page}">
