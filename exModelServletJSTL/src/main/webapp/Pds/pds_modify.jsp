		...
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br> 
				<img src="./img/bullet-01.gif"><font size="3" face="돋움" color="blue"> 
					<b> 뮤직자료실</b></font><font size="2"> - 자료 수정하기</font>
			<p>
				...
				<p>
				<form name="pds" method="post" action="/Pds/pds_modify.do" enctype="multipart/form-data">
					<input type="hidden" name="idx" value="${dto.idx}"> 
					<input type="hidden" name="page" value="${page}"> 
					<input type="hidden" name="filename1" value="${dto.filename}">
					<table border="0">
						<tr>
							<td width="5%" align="right"><img src="./img/bullet-02.gif"></td>
							<td width="15%"><font size="2 face="돋움"">글쓴이</font></td>
							<td width="80%"><input type="text" size="20" name="name" value="${dto.name}"></td>
						</tr>
						<tr>
							<td align="right">&nbsp;</td>
						...
						<tr>
							...
							<td><input type="button" value="수정하기" onClick="check()">&nbsp;
								<input type="button" value="돌아가기" onClick="back()"></td>
						</tr>
					</table></td>
		</tr>
		</form>
