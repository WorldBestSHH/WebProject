...
<body bgcolor="#FFFFFF" text="#000000" leftmargin=0 topmargin=0 onLoad='document.fname.user_id.focus();'>
										...
										<td height="298">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													...
													<td bgcolor="7aaad5">
														<div align="center">
															<font color="#FFFFFF"><b>Member Login</b></font>
														</div>
													</td>
												...
												<tr>
													<td bgcolor="#7aaad5">
														<table border="0" cellpadding="3" cellspacing="1" width="99%" height="321">
															...
															<tr bgcolor="#FFFFFF">
																<td bgcolor="#ffffff" align=CENTER height="138">[아이디찾기]&nbsp;&nbsp;[비밀번호찾기]&nbsp;&nbsp;[회원가입]</td>
															</tr>
															<tr bgcolor="#FFFFFF">
																					...
																					<tr>
																						<td>
																							<p style="LINE-HEIGHT: 15PX;">
																								<font color="#AFAFB1"> 이곳은 JSP를 배우고자 하는 분이면 누구나 
														...
														<table width="100%" border="0" cellspacing="0"
															...
															<tr>
																<td width="9">
																	<img src="./img/h_b04.gif" width="12" height="11"></td>
																<td bgcolor="7aaad5" width="612">
																	<div align="center"></div>
																</td>
																<td width="10">
																	<img src="./img/h_b05.gif" width="12" height="11"></td>
															</tr>
														</table>
													</td>
												</tr>
