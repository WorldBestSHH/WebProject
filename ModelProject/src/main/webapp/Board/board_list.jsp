				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<tr>
						<td colspan="5" align="right" valign="middle" height="20"><font
							size="2" face="고딕">전체 : <b>${totcount}</b>건 - ${page}/
								${totpage} Pages
						</font></td>
					</tr>
					<tr bgcolor="e3e9ff">
					...
					<c:if test="${empty(list)}">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
							<td colspan=5 align="center" height="25"><font face="돋움" size="2" color="#000000">등록된 자료가 없습니다. 
					</c:if>
					<c:if test="${!empty(list)}">
						<c:forEach var="dto" items="${list}">
							<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
								...
								<td align="left" height="20">&nbsp; <font face="돋움" size="2" color="#000000"> 
									<a class="list" href="/Board/board_view.do?idx=${dto.idx}&page=${page}">${dto.subject}</a></td>
								<td align="center" height="20"><font face="돋움" size="2">
									<a class="list" href="mailto:ein1027@nate.com">${dto.name}</a>
								</font></td>
								<td align="center" height="20"><font face="돋움" size="2">${dto.regdate.substring(0,10)}</font></td>
						...
						<table width="600">
							<tr>
									...
									<table>
										<form name="board" method="post" action="/Board/board_list.do">
											...
											<tr>
												...
												<td><a href="javascript:board_search()"><img
								...
								<td width="25%" align="right"><a
									href="/Board/board_write.do?page=${nowpage}"><img
