...
<script>
	function board_delete() {
		url = "/BoardReply/board_delete.do?idx=${dto.idx}&page=${page}";
		...
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br>
				...
				<p align="center">
					<font size="2"> 
						<!-- 새글쓰기 --> 
						<a href="/BoardReply/board_write.do?page=${page}"> 
							<img src="./img/write.jpg" border="0"></a>&nbsp;&nbsp; 
						<!-- 답글쓰기 -->
						<a href="/BoardReply/board_reply.do?idx=${dto.idx}&page=${page}">
							<img src="./img/reply.gif" border="0"></a>&nbsp;&nbsp; 
						<!-- 수정하기 --> 
						<a href="/BoardReply/board_modify.do?idx=${dto.idx}&page=${page}">
							<img src="./img/edit.gif" border="0"> </a>&nbsp;&nbsp; 
						<!-- 삭제하기 --> 
						<a href="javascript:board_delete()">
							<img src="./img/del.gif" border="0"></a>&nbsp;&nbsp; 
						<!-- 목록보기 --> 
						<a href="/BoardReply/board_list.do?page=${page}">
