				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<c:forEach var="dto" items="${list}">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<a class="list" href="/BoardReply/board_view.do?idx=${dto.idx}&page=${page}">${dto.subject}</a></td>
						...
						<table width="600">
							<tr>
								...
								<td width="50%" align="center">
									<table>
										<form name="board" method="post" action="/BoardReply/board_list.do">
								...
								<td width="25%" align="right"><a
									href="/BoardReply/board_write.do?page=${nowpage}"><img
