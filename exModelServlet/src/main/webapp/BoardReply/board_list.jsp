...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			%>		
				<a class="list" href="/BoardReply/board_view.do?idx=<%= dto.getIdx()%>&page=<%= nowpage %>"><%= dto.getSubject() %></a>
			</td>
...
%>
	...
	<table width="600">
		<tr>
			...
			<a href="/BoardReply/board_write.do?page=<%= nowpage %>"><img src="./img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
