       ...
       <tr bgcolor="e3e9ff">
		...
		<tr>  
			<td class="content">
				...
				<a href="upload/${dto.filename}">${dto.filename}</a></font><!-- <a href="javascript:pds_down('${pds.filename}')"> 오류나서 x -->
			</td>
		</tr>
	  </table>
	  <p align="center">
	  <font size="2">
		<a href="/Pds/pds_modify.do?idx=${dto.idx}&page=${page}"><img src="./img/edit-1.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="javascript:pds_delete()"><img src="./img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="/Pds/pds_list.do?page=${page}"><img src="./img/list-2.gif" border="0"></a>
	  </font>
     </td>
  </tr>  
</table>  
