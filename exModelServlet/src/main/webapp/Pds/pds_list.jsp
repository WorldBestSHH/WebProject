...
%>
      <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
		...
		<td align="left" height="20">&nbsp;<font face="돋움" size="2"><a href="/Pds/pds_view.do?idx=<%= dto.getIdx() %>&page=<%= nowpage %>"><%= dto.getSubject() %></a></font></td>
<%
   ...
   <tr>
     ...
     <table border="0" cellspacing="0" width="100%">
      ...
      <form name="pds" method="post" action="/Pds/pds_list.do">
		...
		&nbsp;&nbsp;<a href="javascript:pds_search()"><input type="image" src="./img/search2.gif" align="middle"></a>
	   </td>
	   </tr>
	 </form>
    </table>
