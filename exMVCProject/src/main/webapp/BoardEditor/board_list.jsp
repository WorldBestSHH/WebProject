				...
				<table border="0" cellspacing="1" width="100%" align="center">
					...
					<c:if test="${empty(list)}">
						<tr onMouseOver="style.backgroundColor='#D1EEEE'"
							...
							<td colspan=5 align="center" height="25"><font face="돋움"
								size="2" color="#000000">등록된 자료가 없습니다. 
					</c:if>
					<c:if test="${!empty(list)}">
							...
							<tr onMouseOver="style.backgroundColor='#D1EEEE'"
								...
								<td align="left" height="20">&nbsp; <font face="돋움"
									size="2" color="#000000"> <a class="list"
										href="/BoardEditor/board_view.do?idx=${dto.idx}&page=${page}">${dto.subject}</a></td>
						...
						<table width="600">
							<tr>
								...
								<td width="25%" align="right"><a
									href="/BoardEditor/board_write.do?page=${page}"><img
