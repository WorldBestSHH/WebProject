...
<script>
	function id_check() {
		window.open("id_check.jsp", "id_check",
											...
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr bgcolor=#7AAAD5>
													...
													<td align=right BORDER="0" HSPACE="0" VSPACE="0">
															<img src="./img/u_b03.gif"></td>
												</tr>
											</table>
											<table cellpadding=3 cellspacing=1 border=0 width=100%>
												<tr>
													<td width=110 bgcolor=#EFF4F8>&nbsp;회원 성명
														<font color=red>&nbsp;*</font></td>
													<TD BGCOLOR=WHITE><input type=text name=name size=16 maxlength=20 value="">성명은 빈칸없이 입력하세요.</td>
												</tr>
												<tr>
													...
													<TD BGCOLOR=WHITE>
														<table cellspacing=0 cellpadding=0>
															<tr>
																<td align=absmiddle><input type=text name=userid size=12 maxlength=16 value="" style="width: 120">
																</td>
																<td><a href="javascript:id_check()">
																		<img src="./img/u_bt01.gif" hspace=2 border=0 name=img1 align=absmiddle></a> 
													...
													<TD BGCOLOR=WHITE>
														<table cellspacing=0 cellpadding=0>
															<tr>
																...
																<td><a href="javascript:post_check()">
																	<img src="./img/u_bt07.gif" hspace=2 border=0 name=img2 align=absmiddle></td>
																</a>
															</tr>
														</table>
													</td>
												...
												<tr>
													...
													<td bgcolor=WHITE valign=middle>
														...
														<input type="checkbox" name="fa" value="뉴스">뉴스 <br>
														...
														<input type="checkbox" name="fa" value="학문">학문&nbsp;&nbsp;</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<TD BGCOLOR=WHITE><textarea cols=65 rows=5 name="intro"></textarea></td>
												</tr>
											</table>
											<table cellpadding=0 cellspacing=0 border=0 width=100%>
												<tr bgcolor=#7AAAD5>
												...
												<tr bgcolor=#ffffff>
													<td colspan=3 align=center><a href="javascript:send()">
														<img src="./img/u_bt06.gif" vspace=3 border=0 name=img3></a>
