	...
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br> 
				...
				<font size="3" face="돋움" color="blue"> <b>참 좋은 자료실</b></font> <font size="2"> - 자료올리기</font>
			<p>
					...
					<table border="0">
						...
						<td align=center>
							<a href="javascript:send()">
								<img src="./img/purple_save.gif" width="56" height="18" border="0"></a>
							<a href="javascript:history.back()">
								<img src="./img/purple_cancle.gif" width="56" height="18" border="0"></a>
						</td>
						</tr>
					</table>
				</form>
