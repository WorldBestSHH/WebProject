...
<body topmargin="0" leftmargin="0">
	<table border="0" width="800">
		<tr>
			...
			<td width="80%" valign="top">&nbsp;<br> <img src="/Board/img/bullet-01.gif"><font size="3" face="돋움" color="blue"> 
				<b>자 유 게 시 판</b></font> <font size="2"> - 수정하기</font>
			<p>
					<img src="./img/bullet-03.gif"><font size="2" face="돋움"
						color="orange"> 잠깐</font> &nbsp; <img src="/Board/img/bullet-02.gif"><font
						size="2" face="돋움">는 필수 입력 사항입니다.</font>
				<p>
				<form name="board" method="post" action="/Board?cmd=board_modify_pro.do">
					...
					<table border="0">
						...
						<tr>
							...
							<td><a href="javascript:send()">
									<img src="/Board/img/edit2.gif" border=0></a>&nbsp; 
								<a href="javascript:history.back()">
									<img src="/Board/img/cancle.gif" border=0></a></td>
						</tr>
					</table>
				</form>
			</td>
